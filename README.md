...
### Bible Reading & Verse Actions

<p>
  <img src="docs/assets/gifs/bible-verse-actions.gif" width="300" alt="Bible reading verse action sheet with scripture text blurred" />
</p>
...
<p>
  <img src="docs/assets/screenshots/ai-chapter-summary.png" width="260" alt="AI chapter summary card" />
  <img src="docs/assets/screenshots/person-commentary.png" width="260" alt="Person commentary screen" />
</p>
...
<p>
  <img src="docs/assets/screenshots/reading-plan.png" width="300" alt="Personal reading plan progress screen" />
</p>
...
<p>
  <img src="docs/assets/gifs/search.gif" width="300" alt="Bible search flow with skeleton result cards" />
</p>
...
<p>
  <img src="docs/assets/screenshots/today-verse-permission.png" width="360" alt="Today verse push notification permission sheet" />
</p>
...
<p>
  <img src="docs/assets/screenshots/user-data-sync.png" width="300" alt="My page with account details masked" />
</p>

- Supabase Auth 기반 로그인
- 하이라이트, 저장한 말씀, 사용자 설정 저장
- 로그인 시 API 저장소 사용
...
<p>
  <img src="docs/assets/gifs/tts-reading.gif" width="300" alt="TTS bottom player with scripture text blurred" />
</p>
...
README의 스크린샷과 GIF는 기능 흐름을 보여주는 용도로만 포함했습니다.
저작권 보호 대상 본문이 길게 노출되는 화면은 본문 영역을 blur 처리했고, 계정 식별 정보는 placeholder 형태로 마스킹했습니다.
...
공개 데모가 필요한 경우 공개 가능한 샘플 데이터 또는 별도 허가를 받은 본문 데이터를 주입하는 방식으로 분리할 수 있습니다.
